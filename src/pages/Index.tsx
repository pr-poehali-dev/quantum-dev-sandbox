    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12">
        <div className="flex items-center space-x-2 pl-3 sm:pl-6 lg:pl-12">
          <span className="text-white font-bold text-lg sm:text-xl lg:text-2xl">VideoEdit</span>
        </div>
      ...
      <main className="relative z-10 flex flex-col items-start justify-start sm:justify-center min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-12 max-w-6xl pt-4 sm:-mt-12 lg:-mt-24 pl-6 sm:pl-12 lg:pl-20">
        ...
        <div className="mb-4 sm:mb-8">
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-3 sm:px-4 py-2">
            <span className="text-white text-xs md:text-xs">Фриланс видеомонтаж</span>
          </div>
        </div>
        ...
        <p className="text-white/70 text-sm sm:text-base md:text-sm lg:text-2xl mb-6 sm:mb-8 max-w-2xl text-pretty">
          Профессиональный монтаж для блогеров, брендов и бизнеса.
      ...
      {/* Portfolio Section */}
      <section className="relative z-10 px-6 sm:px-12 lg:px-20 py-20 sm:py-28">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 sm:mb-16">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6">
              <span className="text-white text-xs">Примеры работ</span>
            </div>
            <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
              Смотри, что я{" "}
              <span className="text-orange-400">умею</span>
            </h2>
          </div>
          ...
          <div className="mt-12 text-center">
            <Button className="group relative bg-transparent border border-orange-500/50 hover:border-orange-500 text-orange-400 hover:text-white hover:bg-orange-500 px-8 py-3 rounded-lg text-base font-semibold flex items-center gap-2 mx-auto transition-all duration-300">
              Все работы
